...
const StyledDottedContainer = styled.div`
    width:98%;
    height:240px;
    border:${({theme})=>theme.palette.welcome_banner.mobile.dotted_container.border};
    border-radius:25px;
    margin-top:40px;
`
...
const StyledWelcomeBannerContainer = styled(motion.div)`
    width:100%;
    height:240px;
    border:${({theme})=>theme.palette.welcome_banner.mobile.container.border};
    border-radius:25px;
    position:relative;
    background:${({theme})=>theme.palette.welcome_banner.mobile.container.background};
    display:flex;
    justify-content:center;
    &::after{
        content:"";
        ...
        border:${({theme})=>theme.palette.welcome_banner.mobile.container.trophy_container.border};
        border-radius:50%;
...
const StyledContent = styled.p`
    margin-top:30px;
    color:${({theme})=>theme.palette.welcome_banner.mobile.container.content_text_color};
    font-family:${({theme})=>theme.palette.fontFamily.poppins};
    font-size:15px;
